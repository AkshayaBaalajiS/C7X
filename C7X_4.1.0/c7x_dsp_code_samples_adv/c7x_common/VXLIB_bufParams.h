...
typedef struct
{
    ...
    uint32_t dim_4;  /*!< \brief  Uninitialized when dimension = {VXLIB_2D, VXLIB_3D} */
    uint32_t dim_5;  /*!< \brief  Uninitialized when dimension = {VXLIB_2D, VXLIB_3D, VXLIB_4D} */
    uint32_t dim_6;  /*!< \brief  Uninitialized when dimension = {VXLIB_2D, VXLIB_3D, VXLIB_4D, VXLIB_5D} */

    int32_t  stride_2; /*!< \brief  Stride in bytes */
    int32_t  stride_3; /*!< \brief  Stride in bytes; Uninitialized when dimension = {VXLIB_2D} */
    int32_t  stride_4; /*!< \brief  Stride in bytes; Uninitialized when dimension = {VXLIB_2D, VXLIB_3D} */
    int32_t  stride_5; /*!< \brief  Stride in bytes; Uninitialized when dimension = {VXLIB_2D, VXLIB_3D, VXLIB_4D} */
    int32_t  stride_6; /*!< \brief  Stride in bytes; Uninitialized when dimension = {VXLIB_2D, VXLIB_3D, VXLIB_4D, VXLIB_5D} */
