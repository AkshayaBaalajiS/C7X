...
#define DBG_IDX_ARRAY_SUBSPACE_OPERAND_RESERVED                      1        // Reserved encoding. For defined behavior, software should not use this encoding.
...
#define DBG_IDX_X_STORAGE_SUBSPACE_RESERVED_SIZE                     6        // Reserved field.  Software should write zeros to this field for defined behavior.
#define DBG_IDX_X_STORAGE_SUBSPACE_RESERVED_MSB                      13      
#define DBG_IDX_X_STORAGE_SUBSPACE_RESERVED_LSB                      8       
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_SIZE                         5        // Transfer Buffer address from ROW field of EDI address
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_MSB                          7       
...
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_RSVD0                        28       // Reserved address. Results are not defined when reading this address.
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_RSVD1                        29       // Reserved address. Results are not defined when reading this address.
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_RSVD2                        30       // Reserved address. Results are not defined when reading this address.
#define DBG_IDX_X_STORAGE_SUBSPACE_XREG_RSVD3                        31       // Reserved address. Results are not defined when reading this address.
...
#define src1p_MSB                                                    31      
#define src1p_LSB                                                    0       
#define SRC1P_PARITY_SIZE                                            32       // 16-bit granular parity on src1 operand to MMA
...
#define instr_MSB                                                    19      
#define instr_LSB                                                    0       
#define INSTR_RSVD_SIZE                                              6        // 6-bit reserved field
#define INSTR_RSVD_MSB                                               19      
#define INSTR_RSVD_LSB                                               14      
...
#define rsltp_MSB                                                    31      
#define rsltp_LSB                                                    0       
#define RSLTP_PARITY_SIZE                                            32       // 16-bit granular parity on result to MMA
...
#define RSLT_STATUS_PARITY_SIZE                                      1        // odd parity over the remaining fields in the rslt_status bus
#define RSLT_STATUS_PARITY_MSB                                       7       
#define RSLT_STATUS_PARITY_LSB                                       7       
#define RSLT_STATUS_ERROR_SIZE                                       1        // an error condition was detected in the MMA unit
#define RSLT_STATUS_ERROR_MSB                                        6       
#define RSLT_STATUS_ERROR_LSB                                        6       
...
#define MMA_X_DEPTH                                                  1024     // Number of transfer buffer FIFO vector elements
