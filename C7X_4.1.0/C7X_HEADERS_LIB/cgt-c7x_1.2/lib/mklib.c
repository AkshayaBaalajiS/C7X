...
library_t LIBRARIES[] = {
    { "rts7100_le_eh.lib", { "EXCEPTIONS","EABI_TDEH","LITTLE_ENDIAN" } },
    { "rts7100_be_eh.lib", { "EABI_TDEH","BIG_ENDIAN","EXCEPTIONS" } },
    { "rts7100_le.lib", { "LITTLE_ENDIAN" } },
    { "rts7100_be.lib", { "BIG_ENDIAN" } },
};
